...
\begin{figure}[ht]%
 ...
 \caption{Mikrokontroler Arduino Uno Źródło: opracowanie autora}%
 \label{Fig:arduino}%
\end{figure}
...
\begin{figure}[ht]%
 ...
 \caption{Układ L293D Źródło: opracowanie autora}%
 \label{Fig:l293d}%
\end{figure}
...
\begin{figure}[ht]%
 ...
 \caption{Koło oraz silnik wraz z wyprowadzeniami Źródło: opracowanie autora}%
 \label{Fig:silnikola}%
\end{figure}
...
\begin{figure}[ht]%
 ...
 \caption{Czujnik ultradźwiękowy HC-SR04 Źródło: opracowanie autora}%
 \label{Fig:hcsr04}%
\end{figure}
...
\begin{figure}[ht]%
 ...
 \caption{Element obrotowy MicroServo 9G Źródło: opracowanie autora}%
 \label{Fig:servo}%
\end{figure}
...
\begin{figure}[ht]%
 ...
 \caption{Ogniwa litowo-jonowe 18650 Źródło: opracowanie autora}%
 \label{Fig:baterie}%
\end{figure}
...
\begin{figure}[ht]%
 \centering%
 \includegraphics[width=0.8\textwidth]{figures/przel2.png}%
 \caption{Przełącznik kołyskowy Źródło: opracowanie autora}%
 \label{Fig:przel2}%
\end{figure}
...
Przed przystąpieniem do wykonywania właściwego praktycznego projektu zawsze powinno się przygotować prototyp, aby zweryfikować poprawność założeń projektowych oraz uniknąć niepotrzebnych kosztów. Celem pierwszej konstrukcji było spełnienie celu projektu - stworzenie maszyny, która będzie autonomicznie poruszać się w otoczeniu z możliwością omijania przeszkód. Kwestie dokładności wykonania (precyzyjne poziomowanie kół, klejenie komponentów odpowiednią ilością kleju, odpowiednie rozmieszczenie komponentów na płytce) zostały odsunięte do wykonania końcowego projektu robota. W pierwszym prototypie istniały główne założenia:
\begin{enumerate}
\item Robot ma spełniać cel projektu.
\item Rozmieszczenie komponentów na płytce nie może przenosić środka ciężkości robota poza środek geometryczny konstrukcji (mogłoby to doprowadzić do niezachowania równowagi przy wykonywaniu manewrów).
\end{enumerate}
